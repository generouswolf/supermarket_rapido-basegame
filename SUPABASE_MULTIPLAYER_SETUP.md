...
2. Run the multiplayer migrations in date order in the SQL Editor (including [the shared-pause migration](supabase/migrations/20260827020000_shared_multiplayer_pause.sql)), or deploy them with the Supabase CLI.
